...
export const metadata: Metadata = { title: "PIN код сэргээх" };
  ...
  return (
    <main className="signin-shell">
      <section className="signin-panel">
        ...
        <p className="signin-copy">Бүртгэлтэй имэйлээ оруулна уу. Шинэ 8 оронтой PIN код тохируулах нэг удаагийн холбоос илгээнэ.</p>
        ...
        <form className="signin-form" action={requestPasswordReset}>
          ...
          <div className="signin-actions">
            <button className="primary-button" type="submit" disabled={!configured}>PIN сэргээх холбоос авах</button>
          </div>
        </form>
